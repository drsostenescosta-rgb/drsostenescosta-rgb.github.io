...
**Regras aplicadas a todos os roteiros (vetos do Conselho — AMPLIADOS para todos os conselhos profissionais):**
- Nenhuma promessa de resultado clínico, estético ou financeiro garantido. Projeção sempre nomeada como "projeção com premissas". O veto vale pelo conselho de TODAS as profissões do ICP (CFM, COFFITO, COREN, CFN, CFO, CFBM) — e os mais restritivos (CFN e o campo da estética) dão o teto da campanha inteira.
- **Nenhum "antes e depois" com promessa** — nem de paciente/cliente, nem de faturamento. Nenhuma imagem ou fala que sugira desfecho clínico/estético garantido.
- Nenhuma escassez fabricada. A oferta mencionável é a canônica (2026-07-29): **todos os planos incluem mentoria de implementação + suporte para dúvidas e ajustes durante todo o ano**; preço por mês em **cobrança anual, com o total anual citado** — Start R$ 297/mês (R$ 3.564/ano), Pro R$ 697/mês (R$ 8.364/ano), Aceleração R$ 997/mês (R$ 11.964/ano) — com a regra "preço de lançamento; ajustes futuros não afetam assinaturas ativas", dentro de um beta fundador com acompanhamento direto do Sóstenes. O único limite citável é o real: a capacidade de mentoria 1:1 dele (Aceleração) é limitada pela agenda. Nenhum teto de vagas, nenhum contador, nenhuma promessa de preço eterno.
...
- Tom: honestidade radical do Sóstenes. Zero voz de guru. Falar como quem viveu a clínica por dentro — e ele viveu como fisioterapeuta e biomédico, que agora é literalmente o público.
...
**Variantes por vertical (mesma gravação, capa/legenda diferente):** cortar 3 aberturas alternativas de 2s — "Esteticista:", "Fisio:", "Nutri:" — para testar qual vertical responde melhor ao mesmo vídeo.

---

## Roteiro 2 — DOR: "Agenda cheia, conta vazia" (40–50s)

**Evidência da dor:** landing, seção "A agenda cheia que não vira patrimônio": "atende muito, cobra pouco, depende de indicação"; ICP ampliado pelo Founder (profissionais de saúde de clínica particular que sentem o teto). Esta é a peça dos exemplos por vertical: esteticista de agenda cheia e ticket baixo, fisioterapeuta refém de convênio.
...
**Nota do ICP amplo:** a história ganhou força com a ampliação — o founder É fisioterapeuta e biomédico. Para o novo público, ele não é "o médico que fala com médicos": é um deles que construiu a ferramenta. Usar isso na legenda.
...
**Gancho falado (0–2s):** "Vou fazer o diagnóstico de uma clínica em 3 minutos. Cronometra."
...
| 3–10s | Screen record real: captura.html → formulário (dados fictícios: "Clínica Exemplo", nutricionista) | "Nome, WhatsApp, nicho. O caso de hoje: uma nutricionista de emagrecimento, só consulta avulsa, faturando entre 10 e 30 mil por mês." | caso exemplo: nutri · emagrecimento · R$ 10–30 mil/mês |
| 10–25s | Screen record: as 7 perguntas sendo respondidas, cortes rápidos | "Sete perguntas: nicho, ticket, volume, gargalo, objetivo. Sem pegadinha. O sistema identifica o perfil — aqui deu 'especialista sem captação': ela é ótima no atendimento e ninguém sabe que ela existe. Vale igual pra esteticista, fisio, dentista, médico." | 7 perguntas · perfil: especialista sem captação |
