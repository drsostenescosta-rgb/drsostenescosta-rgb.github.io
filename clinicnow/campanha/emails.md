...
## E-mail 1 — Imediato: "Seu plano está aqui (e o que ele significa)"

**Assunto:** {nome}, seu diagnóstico: {perfil_diagnostico}
**Preview:** O que esse perfil diz sobre a sua clínica — e a primeira ação da semana 1.

**Corpo:**

Oi, {nome}.

Seu diagnóstico apontou o perfil **{perfil_diagnostico}**. Antes de qualquer coisa, o que isso significa em uma frase: o seu gargalo não é competência clínica — é o sistema em volta dela.

Seu plano de 4 semanas já está no seu painel: [Abrir meu plano]

Um pedido honesto: não tente fazer tudo. O plano tem 4 semanas por um motivo. A única coisa que importa hoje é a **primeira ação da semana 1** — geralmente leva menos de uma hora.

Duas notas de transparência, porque é assim que trabalho:

1. A projeção de receita que aparece no seu painel é uma **hipótese** construída a partir das suas respostas (nicho, ticket, volume). As premissas estão visíveis lá. Ela existe para orientar decisão, não para prometer resultado.
2. Você não vai receber pressão de venda por aqui. Vou te mandar mais 4 e-mails nos próximos dias, cada um com uma coisa útil. Se não quiser, o descadastro está no rodapé e funciona de verdade.
...
## E-mail 2 — D+2: valor puro, dor nº 1 (leads que somem)

**Assunto:** o paciente que perguntou o preço e sumiu
**Preview:** Um hábito de 5 minutos por dia que muda sua taxa de resposta.
...
Isso é a semana 3 do seu plano ("roteiro de conversão") começando cedo. Se quiser fazer dentro do sistema, seu funil está aqui: [Abrir meu funil de leads]

— Sóstenes

---

## E-mail 3 — D+4: o "porquê humano" (paciente melhor acompanhado)

**Assunto:** o motivo que ninguém fala para ter recorrência
**Preview:** Não é sobre a sua receita. É sobre o resultado do paciente.
...
## E-mail 4 — D+7: obstáculo real + honestidade sobre o produto

**Assunto:** onde a maioria trava (e o que eu faria)
**Preview:** A semana 2 é a que separa quem executa de quem arquiva o plano.
...
1. Reabrir o plano e marcar o que JÁ foi feito (costuma ser mais do que parece).
...
E uma honestidade sobre o produto: o ClinicNow gratuito te dá o diagnóstico e o plano. A execução acompanhada — metas, projeção, backlog semanal, e principalmente a mentoria de implementação e o suporte para dúvidas e ajustes durante todo o ano — é dos planos pagos (preço por mês em cobrança anual, com preço de lançamento; os valores e o total anual estão na página). Não vou fingir que a versão gratuita faz tudo; ela faz o suficiente para você validar se o método funciona para você. Se estiver funcionando, os planos estão aqui: [Ver planos]

— Sóstenes

---

## E-mail 5 — D+10: convite para a conversa (sem pressão)

**Assunto:** 15 minutos, eu e você, sobre a sua clínica
**Preview:** Não é call de vendas. É a parte do trabalho que eu mais gosto.

**Corpo:**

{nome},

último e-mail dessa sequência — depois daqui, você só me ouve quando tiver algo útil de verdade.

Quero te fazer um convite direto: **15 minutos de conversa no WhatsApp, comigo, sobre o seu plano.** Você me conta onde travou (ou onde andou), e eu te digo o que eu enxergo — com a experiência de quem passou dez anos dentro de clínica e hoje constrói ferramenta para elas.
...
Se não topar, sem problema nenhum — o plano continua seu, o funil continua seu, e eu continuo torcendo.
...
4. **Preços ratificados e publicados.** Os e-mails 4 e 5 referenciam a oferta vigente (2026-07-29): todos os planos com mentoria de implementação + suporte anual; preço por mês em cobrança anual — Start R$ 297/mês (R$ 3.564/ano), Pro R$ 697/mês (R$ 8.364/ano), Aceleração R$ 997/mês (R$ 11.964/ano) — ratificável pelo Founder. Antes do disparo: Founder ratifica os valores, os termos e a página de planos exibem exatamente esses números (com o total anual visível — CDC) e a regra "ajustes futuros não afetam assinaturas ativas". E-mail prometendo preço que a página não confirma é quebra de confiança na primeira dobra. Dono: Founder + Engenharia.
...
## Métricas da sequência (alvos e critérios)
| Métrica | Alvo | Critério de ação |
|---|---|---|
| Abertura e-mail 1 | > 60% (transacional) | < 40% → problema de entregabilidade/assunto, revisar antes de julgar conteúdo |
| Abertura média e-mails 2–5 | > 35% | < 25% por 2 envios seguidos → reescrever assuntos |
| Clique no CTA (por e-mail) | > 8% | — |
| Conversas iniciadas (e-mail 5) | > 10% dos que abriram | < 5% → testar mover o convite do e-mail 5 para o 3 |
| Descadastro | < 1,5% por envio | > 3% em qualquer e-mail → esse e-mail sai da sequência e volta à mesa |
